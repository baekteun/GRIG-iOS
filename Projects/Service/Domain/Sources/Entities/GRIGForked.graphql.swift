  ...
  final class GrigForkedQuery: GraphQLQuery {
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public struct Ranking: GraphQLSelectionSet {
        ...
        public init(name: String? = nil, generation: Int? = nil, nickname: String? = nil, bio: String? = nil, avatarUrl: String? = nil, forked: Int? = nil) {
          self.init(unsafeResultMap: ["__typename": "User", "name": name, "generation": generation, "nickname": nickname, "bio": bio, "avatar_url": avatarUrl, "forked": forked])
        }
