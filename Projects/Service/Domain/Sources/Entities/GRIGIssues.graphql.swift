...
public extension GRIGAPI {
  final class GrigIssuesQuery: GraphQLQuery {
    /// The raw GraphQL definition of this operation.
    public let operationDefinition: String =
      """
      query GRIGIssues($criteria: String, $count: Int, $page: Int, $generation: Int) {
        ranking(
          criteria: $criteria
          count: $count
          page: $page
    ...
    public let operationName: String = "GRIGIssues"
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public struct Ranking: GraphQLSelectionSet {
        ...
        public init(name: String? = nil, nickname: String? = nil, generation: Int? = nil, bio: String? = nil, avatarUrl: String? = nil, issues: Int? = nil) {
          self.init(unsafeResultMap: ["__typename": "User", "name": name, "nickname": nickname, "generation": generation, "bio": bio, "avatar_url": avatarUrl, "issues": issues])
        }
