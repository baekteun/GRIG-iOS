...
public extension GRIGAPI {
  final class GrigPullRequestsQuery: GraphQLQuery {
    /// The raw GraphQL definition of this operation.
    public let operationDefinition: String =
      """
      query GRIGPullRequests($criteria: String, $count: Int, $page: Int, $generation: Int) {
        ranking(
          criteria: $criteria
          count: $count
          page: $page
    ...
    public let operationName: String = "GRIGPullRequests"
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public struct Ranking: GraphQLSelectionSet {
        ...
        public init(name: String? = nil, nickname: String? = nil, generation: Int? = nil, bio: String? = nil, avatarUrl: String? = nil, pullRequests: Int? = nil) {
          self.init(unsafeResultMap: ["__typename": "User", "name": name, "nickname": nickname, "generation": generation, "bio": bio, "avatar_url": avatarUrl, "pullRequests": pullRequests])
        }
