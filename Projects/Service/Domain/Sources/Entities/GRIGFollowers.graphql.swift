...
public extension GRIGAPI {
  final class GrigFollowersQuery: GraphQLQuery {
    /// The raw GraphQL definition of this operation.
    public let operationDefinition: String =
      """
      query GRIGFollowers($criteria: String, $count: Int, $page: Int, $generation: Int) {
        ranking(
          criteria: $criteria
          count: $count
          page: $page
    ...
    public let operationName: String = "GRIGFollowers"
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public struct Ranking: GraphQLSelectionSet {
        ...
        public init(name: String? = nil, generation: Int? = nil, nickname: String? = nil, bio: String? = nil, avatarUrl: String? = nil, followers: Int? = nil) {
          self.init(unsafeResultMap: ["__typename": "User", "name": name, "generation": generation, "nickname": nickname, "bio": bio, "avatar_url": avatarUrl, "followers": followers])
        }
